        ...
        <div class="white-box">
            ...
            <div id="pnlSecurity">
                ...
                {!! Form::open(['action' => ['Maintenance\AccountController@changePassword', Auth::user()->id], 'method' => 'POST', 
                    'enctype' => 'multipart/form-data', 'onsubmit' => "return confirm('Change your password?')", 'class' => 'form-material form-horizontal', 'style' => 'padding-left:80px; padding-right:80px;']) !!}
                    @csrf
                    <div class="form-group">
