<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)"
        ...
        <div class="top-left-part"><a class="logo" href="index.html"><b><img src="{{ asset('elite/plugins/images/eliteadmin-logo.png') }}"
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <ul class="dropdown-menu mailbox animated bounceInDown">
                    ...
                    <li>
                        <div class="message-center">
                            <a href="#">
                                <div class="user-img"> <img src="{{ asset('elite/plugins/images/users/pawandeep.jpg') }}" alt="user"
                            ...
                            <a href="#">
                                <div class="user-img"> <img src="{{ asset('elite/plugins/images/users/sonu.jpg') }}" alt="user" class="img-circle">                                            <span
                            ...
                            <a href="#">
                                <div class="user-img"> <img src="{{ asset('elite/plugins/images/users/arijit.jpg') }}" alt="user" class="img-circle">                                            <span
                    ...
                    <li>
                        <a class="text-center" href="javascript:void(0);"> <strong>See all notifications</strong>
            ...
            <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i
                ...
                <ul class="dropdown-menu dropdown-tasks animated slideInUp">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a class="text-center" href="#"> <strong>See All Tasks</strong> <i class="fa fa-angle-right"></i>
                            </a>
                    </li>
                </ul>
                <!-- /.dropdown-tasks -->
            ...
            <li class="dropdown">
                <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="{{ asset('elite/plugins/images/users/d1.jpg') }}"
                        alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Dr. Steave</b> </a>
